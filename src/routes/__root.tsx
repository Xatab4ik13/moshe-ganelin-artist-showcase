...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Moshe Ariel Ganelin" },
    ...
    links: [
      ...
      { rel: "preload", href: "/fonts/mostra-nuova-regular.woff2", as: "font", type: "font/woff2", crossOrigin: "anonymous" },
      { rel: "preload", href: "/fonts/mostra-nuova-heavy.woff2", as: "font", type: "font/woff2", crossOrigin: "anonymous" },
