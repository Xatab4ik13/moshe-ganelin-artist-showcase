  ...
  return (
    <PageShell title={t("aboutTitle")} lead={t("aboutLead")} image={img.organWide}>
      <section id="bio" className="relative scroll-mt-24 overflow-hidden px-5 py-24 md:px-10 lg:px-16 lg:py-32">
        ...
        <div className="relative mx-auto grid max-w-[1600px] gap-16 lg:grid-cols-[1.2fr_1fr]">
          ...
          <Reveal delay={120} className="media-zoom overflow-hidden">
            <img src={img.console} alt="Moshe Ariel Ganelin at the organ console" loading="lazy" className="aspect-[4/5] w-full object-cover" />
          </Reveal>
        </div>
      ...
      <section className="relative overflow-hidden py-24 text-background lg:py-32">
        <img src={img.piano} alt="" aria-hidden="true" loading="lazy" decoding="async" className="absolute inset-0 h-full w-full object-cover" />
