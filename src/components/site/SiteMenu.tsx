    ...
    <>
      ...
      >
        <span className="relative block h-10 w-10 md:h-12 md:w-12" aria-hidden="true">
          <span className={`absolute inset-0 flex flex-col items-center justify-center transition-all duration-300 ${menuOpen ? "gap-0" : "gap-[7px]"}`}>
            <span className={`h-[3.5px] w-full bg-current transition-all duration-300 ${menuOpen ? "rotate-45" : ""}`} />
            <span className={`h-[3.5px] w-full bg-current transition-all duration-300 ${menuOpen ? "opacity-0" : "opacity-100"}`} />
            <span className={`h-[3.5px] w-full bg-current transition-all duration-300 ${menuOpen ? "-rotate-45" : ""}`} />
          </span>
        </span>
