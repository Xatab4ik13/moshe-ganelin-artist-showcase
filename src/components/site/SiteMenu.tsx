  ...
  return (
    <>
      ...
      <button
        ...
        className={`group menu-burger fixed right-[calc(1.25rem_+_var(--scrollbar-width))] top-2 z-50 flex w-[8.5rem] flex-col items-center p-2 opacity-90 transition-opacity duration-300 hover:opacity-100 focus:outline-none md:right-[calc(1.5rem_+_var(--scrollbar-width))] md:top-5 md:w-[13rem] md:p-3 ${barTone}`}
      >
