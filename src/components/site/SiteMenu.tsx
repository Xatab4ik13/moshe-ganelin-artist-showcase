    ...
    <>
      ...
      >
        <span className="relative block h-8 w-8 md:h-10 md:w-10" aria-hidden="true">
          <span className={`menu-stroke absolute left-1/2 top-1/2 h-[2.5px] w-[80%] -translate-x-1/2 -translate-y-1/2 bg-current ${menuOpen ? "rotate-45" : "-translate-y-2 md:-translate-y-2.5"}`} />
